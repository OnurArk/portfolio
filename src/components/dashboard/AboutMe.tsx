  ...
  return (
    <Card>
      <CardContent sx={{position: "relative", display: "flex", flexDirection: "column", gap: 2 }}>
        <Box sx={{position: "absolute", top: 0, left: 0, p: 2, backgroundColor: "primary.main", 
            boxShadow: `0 12px 30px ${custom.card.shadowColor}` , borderRadius:"0 20px 0 20px" }}>
            <Typography color="text.invertedText" sx={{alignSelf:"center"}}>{t("dashboard.aboutMeTitle")}</Typography>
        </Box>
